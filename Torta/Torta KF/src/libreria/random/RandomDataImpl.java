...
import libreria.distribution.IntegerDistribution;
import libreria.distribution.RealDistribution;
import libreria.exception.NotANumberException;
import libreria.exception.NotFiniteNumberException;
import libreria.exception.NotPositiveException;
import libreria.exception.NotStrictlyPositiveException;
import libreria.exception.MathIllegalArgumentException;
import libreria.exception.NumberIsTooLargeException;
...
public class RandomDataImpl implements RandomData, Serializable {
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.BetaDistribution Beta Distribution}.
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.BinomialDistribution Binomial Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.CauchyDistribution Cauchy Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.ChiSquaredDistribution ChiSquare Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.FDistribution F Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
     ...
     * {@link libreria.distribution.GammaDistribution Gamma Distribution}.</p>
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.HypergeometricDistribution Hypergeometric Distribution}.
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.PascalDistribution Pascal Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.TDistribution T Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.WeibullDistribution Weibull Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link libreria.distribution.ZipfDistribution Zipf Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
