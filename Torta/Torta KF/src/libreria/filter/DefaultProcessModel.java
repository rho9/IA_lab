...
import libreria.linear.*;

/**
 * Default implementation of a {@link ProcessModel} for the use with a {@link DecompositionSolver.KalmanFilter}.
 *
 * @since 3.0
 */
public class DefaultProcessModel implements ProcessModel {
     ...
     * {@link DecompositionSolver.KalmanFilter} to default values.
     *
     * @param stateTransition
     *            the state transition matrix
     * @param control
