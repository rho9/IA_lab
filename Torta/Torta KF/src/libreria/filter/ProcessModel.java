...
/**
 * Defines the process dynamics model for the use with a {@link DecompositionSolver.KalmanFilter}.
 *
 * @since 3.0
 */
public interface ProcessModel {
    ...
    /**
     * Returns the process noise matrix. This method is called by the {@link DecompositionSolver.KalmanFilter} every
     ...
     * @see DecompositionSolver.KalmanFilter#predict()
     * @see DecompositionSolver.KalmanFilter#predict(double[])
     * @see DecompositionSolver.KalmanFilter#predict(RealVector)
     */
