...
import libreria.random.UnitSphereRandomVectorGenerator;
...
public class MicrosphereProjectionInterpolator
     ...
     * will be returned).
     * @throws libreria.exception.NotStrictlyPositiveException
     * if {@code dimension <= 0} or {@code elements <= 0}.
     * @throws NotPositiveException if {@code exponent < 0}.
     * @throws NotPositiveException if {@code darkThreshold < 0}.
     * @throws libreria.exception.OutOfRangeException if
