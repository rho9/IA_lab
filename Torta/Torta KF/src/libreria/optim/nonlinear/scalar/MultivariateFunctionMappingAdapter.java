 ...
 */
package libreria.optim.nonlinear.scalar;

import libreria.analysis.MultivariateFunction;
import libreria.analysis.UnivariateFunction;
import libreria.analysis.function.Logit;
import libreria.analysis.function.Sigmoid;
 ...
 * libreria.optimization.BaseMultivariateOptimizer#optimize(int,
 * MultivariateFunction, libreria.optimization.GoalType, double[])}
 ...
 * {@link libreria.optim.nonlinear.scalar.noderiv.SimplexOptimizer
 * SimplexOptimizer}.
 * A better solution is to use an optimizer that directly supports simple bounds like
 * {@link libreria.optim.nonlinear.scalar.noderiv.CMAESOptimizer
 * CMAESOptimizer} or
 * {@link libreria.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer
 * BOBYQAOptimizer}.
