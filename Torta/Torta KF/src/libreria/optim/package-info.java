 ...
 *  {@link libreria.optim.nonlinear.scalar.GoalType#MINIMIZE minimize} or
 *  {@link libreria.optim.nonlinear.scalar.GoalType#MAXIMIZE maximize}
 *  a scalar function, called the
 *  {@link libreria.optim.nonlinear.scalar.ObjectiveFunction <em>objective
 *  function</em>}.
 *  <br/>
 ...
 *  {@link libreria.optim.nonlinear.scalar.gradient} package.
 *  The algorithms that do not need this additional information are located in
 *  the {@link libreria.optim.nonlinear.scalar.noderiv} package.
 * </p>
 *
 * <p>
 *  Some problems are solved more efficiently by algorithms that, instead of an
 *  objective function, need access to a
 *  {@link libreria.optim.nonlinear.vector.ModelFunction
 *  <em>model function</em>}: such a model predicts a set of values which the
 *  algorithm tries to match with a set of given
 *  {@link libreria.optim.nonlinear.vector.Target target values}.
 *  Those algorithms are located in the
 *  {@link libreria.optim.nonlinear.vector} package.
 *  <br/>
 *  Algorithms that also require the
 *  {@link libreria.optim.nonlinear.vector.ModelFunctionJacobian
 *  Jacobian matrix of the model} are located in the
 *  {@link libreria.optim.nonlinear.vector.jacobian} package.
 *  <br/>
 *  The {@link libreria.optim.nonlinear.vector.jacobian.AbstractLeastSquaresOptimizer
 ...
 *  {@link libreria.optim.nonlinear.scalar.LeastSquaresConverter
 ...
 *  Abstract classes ({@link libreria.optim.BaseOptimizer} and
 *  {@link libreria.optim.BaseMultivariateOptimizer}) contain
 *  boiler-plate code for storing {@link libreria.optim.MaxEval
 *  evaluations} and {@link libreria.optim.MaxIter iterations}
 *  counters and a user-defined
 *  {@link libreria.optim.ConvergenceChecker convergence checker}.
 * </p>
 *
 * <p>
