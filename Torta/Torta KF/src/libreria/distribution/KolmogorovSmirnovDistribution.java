...
import libreria.linear.Array2DRowRealMatrix;
 ...
 *  use {@link libreria.stat.inference.KolmogorovSmirnovTest}
 */
public class KolmogorovSmirnovDistribution implements Serializable {
     ...
     * {@link libreria.fraction.BigFraction} everywhere at the
     ...
     * in [1] and {@link libreria.fraction.BigFraction} (see
     * above).
     *
     * @param d statistic
     * @return the two-sided probability of {@code P(D_n < d)}
     ...
     * {@code h} to a {@link libreria.fraction.BigFraction} in
