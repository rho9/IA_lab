...
import libreria.distribution.EnumeratedRealDistribution;
import libreria.distribution.RealDistribution;
import libreria.distribution.UniformRealDistribution;
import libreria.exception.InsufficientDataException;
import libreria.exception.MathArithmeticException;
...
import libreria.exception.TooManyIterationsException;
import libreria.exception.util.LocalizedFormats;
import libreria.fraction.BigFraction;
import libreria.fraction.BigFractionField;
import libreria.fraction.FractionConversionException;
import libreria.linear.Array2DRowFieldMatrix;
import libreria.linear.FieldMatrix;
import libreria.linear.MatrixUtils;
import libreria.linear.RealMatrix;
import libreria.random.JDKRandomGenerator;
import libreria.random.RandomGenerator;
import libreria.random.Well19937c;
import libreria.util.CombinatoricsUtils;
import libreria.util.FastMath;
import libreria.util.MathArrays;
import libreria.util.MathUtils;
...
public class KolmogorovSmirnovTest {
     ...
     * {@code double} rather than {@link libreria.fraction.BigFraction}.
     *
     * @param d statistic
     * @param n sample size
     * @return \(P(D_n < d)\)
     * @throws MathArithmeticException if algorithm fails to convert {@code h} to a
     *         {@link libreria.fraction.BigFraction} in expressing {@code d} as \((k
     ...
     *        {@link libreria.fraction.BigFraction} everywhere at the expense of
     ...
     * in class javadoc above) and {@link libreria.fraction.BigFraction} (see
     * above).
     *
     * @param d statistic
     * @param n sample size
