 ...
 */
package libreria.stat.inference;

import java.util.Collection;

import libreria.distribution.RealDistribution;
import libreria.exception.ConvergenceException;
import libreria.exception.DimensionMismatchException;
import libreria.exception.InsufficientDataException;
import libreria.exception.MaxCountExceededException;
import libreria.exception.NoDataException;
import libreria.exception.NotPositiveException;
import libreria.exception.NotStrictlyPositiveException;
import libreria.exception.NullArgumentException;
import libreria.exception.NumberIsTooSmallException;
import libreria.exception.OutOfRangeException;
import libreria.exception.ZeroException;
import libreria.stat.descriptive.StatisticalSummary;
...
public class TestUtils  {
    ...
    /**
     * @see libreria.stat.inference.TTest#homoscedasticT(double[], double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#homoscedasticT(libreria.stat.descriptive.StatisticalSummary, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#homoscedasticTTest(double[], double[], double)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#homoscedasticTTest(double[], double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#homoscedasticTTest(libreria.stat.descriptive.StatisticalSummary, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#pairedT(double[], double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#pairedTTest(double[], double[], double)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#pairedTTest(double[], double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#t(double, double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#t(double, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#t(libreria.stat.descriptive.StatisticalSummary, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(double, double[], double)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(double, double[])
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(double, libreria.stat.descriptive.StatisticalSummary, double)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(double, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(libreria.stat.descriptive.StatisticalSummary, libreria.stat.descriptive.StatisticalSummary, double)
     */
    ...
    /**
     * @see libreria.stat.inference.TTest#tTest(libreria.stat.descriptive.StatisticalSummary, libreria.stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquare(double[], long[])
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquare(long[][])
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTest(double[], long[], double)
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTest(double[], long[])
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTest(long[][], double)
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTest(long[][])
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see libreria.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[], double)
     *
     * @since 1.2
     */
    ...
    /**
     * @see libreria.stat.inference.OneWayAnova#anovaFValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see libreria.stat.inference.OneWayAnova#anovaPValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see libreria.stat.inference.OneWayAnova#anovaTest(Collection,double)
     *
     * @since 1.2
     */
    public static boolean oneWayAnovaTest(final Collection<double[]> categoryData,
     ...
     /**
     * @see libreria.stat.inference.GTest#g(double[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#gTest( double[],  long[] )
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#gTestIntrinsic(double[], long[] )
     * @since 3.1
     */
    public static double gTestIntrinsic(final double[] expected, final long[] observed)
     ...
     /**
     * @see libreria.stat.inference.GTest#gTest( double[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#gDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#rootLogLikelihoodRatio(long, long, long, long)
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#gTestDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.GTest#gTestDataSetsComparison(long[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], double)
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#exactP(double, int, int, boolean)
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#approximateP(double, int, int)
     * @since 3.3
     */
    ...
    /**
     * @see libreria.stat.inference.KolmogorovSmirnovTest#monteCarloP(double, int, int, boolean, int)
     * @since 3.3
     */
